...
class PengeluaranMainPage extends StatefulWidget {
  PengeluaranMainPage({Key? key}) : super(key: key);

  @override
  _PengeluaranMainPageState createState() => _PengeluaranMainPageState();
}

class _PengeluaranMainPageState extends State<PengeluaranMainPage> {
  ValueNotifier<bool> showForm = ValueNotifier(false);
  ValueNotifier<bool> isDetail = ValueNotifier(false);
  ValueNotifier<Pengeluaran?> userBringData = ValueNotifier(null);
                        ...
                        children: [
                          ...
                          BlocBuilder<FetchCubit, FetchState>(
                              ...
                              builder: (context, state) {
                                ...
                                } else if (state is ListPengeluaranLoaded) {
                                  List<Pengeluaran> dataFinal = state.data;
                                  dataFinal.sort((a, b) => b.tanggalLocal!
                                      .compareTo(a.tanggalLocal!));

                                  List<Pengeluaran> dataAfterFilter = [];
                                                                ...
                                                                Flexible(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    width: double
                                                                        .infinity,
                                                                    child: Text(
                                                                      state.data[index].notes.isEmpty
                                                                          ? '-'
                                                                          : state
                                                                              .data[index]
                                                                              .notes,
                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            EasyLoading.show(
                                                                status:
                                                                    'Mohon Tunggu');
                                                            PengeluaranService.deletePengeluaran(
                                                                    id: state
                                                                        .data[
                                                                            index]
                                                                        .id
